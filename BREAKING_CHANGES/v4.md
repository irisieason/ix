...
Projects using `@irisieason/ix-angular` must upgrade to Angular 20 before updating to this version.
...
```typescript
import { themeSwitcher } from '@irisieason/ix-angular';
```
...
@import '@irisieason/ix-aggrid/dist/ix-aggrid/ix-aggrid.css';
```
...
```javascript
import { getIxTheme, getIxThemeAsync } from '@irisieason/ix-aggrid';
