...
import { IxDeviceStatusChart as IxDeviceStatusChartElement } from "@irisieason/ix/components/ix-device-status-chart.js";
...
export const IxDeviceStatusChart: StencilReactComponent<IxDeviceStatusChartElement, IxDeviceStatusChartEvents> = /*@__PURE__*/ createComponent<IxDeviceStatusChartElement, IxDeviceStatusChartEvents>({
    ...
    hydrateModule: import('@irisieason/ix/hydrate') as Promise<HydrateModule>,
    clientModule: clientComponents.IxDeviceStatusChart as ReactWebComponent<IxDeviceStatusChartElement, IxDeviceStatusChartEvents>,
    serializeShadowRoot,
});
...
export const IxEventItemContent: StencilReactComponent<IxEventItemContentElement, IxEventItemContentEvents> = /*@__PURE__*/ createComponent<IxEventItemContentElement, IxEventItemContentEvents>({
    ...
    properties: {
        ...
        target: 'target',
        rel: 'rel',
        iconButtonA11yLabel: 'icon-button-a-1-1y-label',
        iconButtonVariant: 'icon-button-variant',
        oval: 'oval',
        iconButtonIcon: 'icon-button-icon',
        iconButtonSize: 'icon-button-size',
        iconColor: 'icon-color',
        iconButtonDisabled: 'icon-button-disabled',
        iconButtonType: 'icon-button-type',
        iconButtonLoading: 'icon-button-loading'
    },
    hydrateModule: import('@irisieason/ix/hydrate') as Promise<HydrateModule>,
