...
regressionTest.describe('icon-toggle-button: basic', () => {
  regressionTest('should not have visual regressions', async ({ page }) => {
    await page.goto('icon-toggle-button/basic');
  ...
  regressionTest('should have a hover effect', async ({ page }) => {
    ...
    await page.waitForSelector('ix-icon-toggle-button > button.hover');
  ...
  regressionTest('should have an active effect', async ({ page }) => {
    ...
    await page.waitForSelector('ix-icon-toggle-button > button.active');

    expect(await page.screenshot({ fullPage: true })).toMatchSnapshot();
  });

  regressionTest('should show loading spinner', async ({ page }) => {
    await page.goto('icon-toggle-button/loading');
